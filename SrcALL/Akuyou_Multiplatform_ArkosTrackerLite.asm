...
; As this option is system-friendly, it cuts the interruption,
; and restore them ONLY IF NECESSARY.
PLY_SystemFriendly equ 0


; Set to 1 to use a Player under interruption.
; Only works on CPC, as it uses the CPC Firmware.
...
; Set to 1 if you want a little interface to be added if you are a BASIC
; programmer who wants to use sound effects.
; Of course, you must also set PLY_UseSoundEffects to 1.
PLY_UseBasicSoundEffectInterface equ 0

; Value used to trigger the Retrig of Register 13. #FE corresponds to CP xx.
; Do not change it !
PLY_RetrigValue equ #fe
...
; E = No Channel (0,1,2)
; I used the E register instead of A so that Basic users can call this code in
; a straightforward way (call player+15, value).

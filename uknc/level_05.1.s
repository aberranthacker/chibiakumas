...
S01Tentitack:
    .incbin "build/level_05/s01_tentitack.1.bin"
S01TentitackMask:
    .incbin "build/level_05/s01_tentitack_mask.1.bin"
    .even

S02Superfish:
    .incbin "build/level_05/s02_superfish.1.bin"
S02SuperfishMask:
    .incbin "build/level_05/s02_superfish_mask.1.bin"
    .even

S03Lilifrog:
    .incbin "build/level_05/s03_lilifrog.1.bin"
S03LilifrogMask:
    .incbin "build/level_05/s03_lilifrog_mask.1.bin"
    .even

S04Spitfish:
    .incbin "build/level_05/s04_spitfish.1.bin"
S04SpitfishMask:
    .incbin "build/level_05/s04_spitfish_mask.1.bin"
    .even

S05SpitfishBomber:
    .incbin "build/level_05/s05_spitfish_bomber.1.bin"
S05SpitfishBomberMask:
    .incbin "build/level_05/s05_spitfish_bomber_mask.1.bin"
    .even

S06Pairanah:
    .incbin "build/level_05/s06_pairanah.1.bin"
S06PairanahMask:
    .incbin "build/level_05/s06_pairanah_mask.1.bin"
    .even

S07Bubble24:
    .incbin "build/level_05/s07_bubble24.1.bin"
S07Bubble24Mask:
    .incbin "build/level_05/s07_bubble24_mask.1.bin"
    .even

S08Bubble16:
    .incbin "build/level_05/s08_bubble16.1.bin"
S08Bubble16Mask:
    .incbin "build/level_05/s08_bubble16_mask.1.bin"
    .even

S09Minerfish:
    .incbin "build/level_05/s09_minerfish.1.bin"
S09MinerfishMask:
    .incbin "build/level_05/s09_minerfish_mask.1.bin"
    .even

S10Coin:
    .incbin "build/level_05/s10_coin.1.bin"
S10CoinMask:
    .incbin "build/level_05/s10_coin_mask.1.bin"
    .even

S11FishfaceLeft:
    .incbin "build/level_05/s11_fishface_left.1.bin"
S11FishfaceLeftMask:
    .incbin "build/level_05/s11_fishface_left_mask.1.bin"
    .even

S12FishboneLeft:
    .incbin "build/level_05/s12_fishbone_left.1.bin"
S12FishboneLeftMask:
    .incbin "build/level_05/s12_fishbone_left_mask.1.bin"
    .even

S13PowerupPower:
    .incbin "build/level_05/s13_powerup_power.1.bin"
S13PowerupPowerMask:
    .incbin "build/level_05/s13_powerup_power_mask.1.bin"
    .even

S14PowerupRate:
    .incbin "build/level_05/s14_powerup_rate.1.bin"
S14PowerupRateMask:
    .incbin "build/level_05/s14_powerup_rate_mask.1.bin"
    .even

S15PowerupDrone:
    .incbin "build/level_05/s15_powerup_drone.1.bin"
S15PowerupDroneMask:
    .incbin "build/level_05/s15_powerup_drone_mask.1.bin"
    .even

S16Wave1:
    .incbin "build/level_05/s16_wave1.1.bin"
S16Wave1Mask:
    .incbin "build/level_05/s16_wave1_mask.1.bin"
    .even

S17Wave2:
    .incbin "build/level_05/s17_wave2.1.bin"
S17Wave2Mask:
    .incbin "build/level_05/s17_wave2_mask.1.bin"
    .even

S18Wave3:
    .incbin "build/level_05/s18_wave3.1.bin"
S18Wave3Mask:
    .incbin "build/level_05/s18_wave3_mask.1.bin"
    .even

S19Weed1:
    .incbin "build/level_05/s19_weed1.1.bin"

S20Weed2:
    .incbin "build/level_05/s20_weed2.1.bin"

S21Coral1:
    .incbin "build/level_05/s21_coral1.1.bin"

S22Coral2:
    .incbin "build/level_05/s22_coral2.1.bin"

S23FishfaceRight:
    .incbin "build/level_05/s23_fishface_right.1.bin"
S23FishfaceRightMask:
    .incbin "build/level_05/s23_fishface_right_mask.1.bin"
    .even

S24FishboneRight:
    .incbin "build/level_05/s24_fishbone_right.1.bin"
S24FishboneRightMask:
    .incbin "build/level_05/s24_fishbone_right_mask.1.bin"
    .even

S25Tuffet:
    .incbin "build/level_05/s25_tuffet.1.bin"

S26Grass1:
    .incbin "build/level_05/s26_grass1.1.bin"

S27Grass2:
    .incbin "build/level_05/s27_grass2.1.bin"

S28Bush:
    .incbin "build/level_05/s28_bush.1.bin"

S29Rock1:
    .incbin "build/level_05/s29_rock1.1.bin"

S30Rock2:
    .incbin "build/level_05/s30_rock2.1.bin"

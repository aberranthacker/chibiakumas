...
648 y=2: x=9:CALL &8048,x*6,24*y+8-16,6*3,16,0,0,&8039
649 x=9+3:CALL &8048,x*6,24*y+8-16,6,16,0,0,&8039
651 FOR y=2 TO 6
652 x=9:CALL &8048,x*6,24*y+8,6*3,24,0,0,&8039
653 x=9+3:CALL &8048,x*6,24*y+8,6,24,0,0,&8039
655 NEXT
658 y=2: x=5:CALL &8048,x*6,24*y+8-16,6*3,16,0,0,&8039
659 x=5+3:CALL &8048,x*6,24*y+8-16,6,16,0,0,&8039

660 FOR y=2 TO 6edit 2z
661 x=5:CALL &8048,x*6,24*y+8,6*3,24,0,0,&8039
662 x=5+3:CALL &8048,x*6,24*y+8,6,24,0,0,&8039
663 NEXT
664 y=7:x=5:CALL &8048,x*6,24*y-8,6*3,16,0,0,&8039
665 x=5+3:CALL &8048,x*6,24*y-8,6,16,0,0,&8039

...
; We have Code which needs to be altered depending on our screen location, we
; do it all here to save time
...
Player_StarArray_Prep2:
    ...
    ; We need to leave this function with the RET Z ver in BC , and the JP Z
    ; version in hl this is so our level can do it's own tricks!
    ret

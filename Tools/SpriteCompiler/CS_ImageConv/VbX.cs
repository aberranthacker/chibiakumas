...
public static class VbX
{
    ...
    public static Form PopForm(String title, String promptText, String value, ref TextBox t)
    {
        ...
        textBox.Font = new System.Drawing.Font("", 14F, System.Drawing.FontStyle.Regular, System.Drawing.GraphicsUnit.Point, ((byte)(0)));
    ...
    public static string Mid(String Lin, int Start, int len) { if (len < 1) return ""; else if (len > Lin.Length) return ""; else return Lin.Substring(Start - 1, len); }
    ...
    public static void MsgBox(String lin)
    {
        ...
        InputBox("Benkyou Studio", lin, "okonly");
